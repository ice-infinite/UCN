...
仓库同时发布 Core 源码、单元/虚拟拓扑测试、CMake 配置，以及 `docs/` 下的架构、协议设计、任务表和项目操作记录。开始接入时先阅读 [UCN 使用与调用手册](docs/UCN_使用与调用手册.md)，再按需要进入 [UCN v4 协议核心说明](docs/UCN_v4_协议核心说明.md)、完整架构和专题设计文档。
