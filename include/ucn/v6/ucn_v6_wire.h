...
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_HELLO UINT16_C(128)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_COOKIE_CHALLENGE UINT16_C(129)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_HELLO_COOKIE UINT16_C(130)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_IDENTITY_CHALLENGE UINT16_C(131)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_IDENTITY_RESPONSE UINT16_C(132)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_ADDRESS_OFFER UINT16_C(133)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_DEVICE_COMMIT UINT16_C(134)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_FINAL_COMMIT UINT16_C(135)
#define UCN_V6_PROTOCOL_OPCODE_BOOTSTRAP_ABORT UINT16_C(136)
...
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_DISCOVER_REQUEST UINT16_C(1024)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_DISCOVER_RESPONSE UINT16_C(1025)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_PATH_PROBE UINT16_C(1026)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_PATH_PROBE_ACK UINT16_C(1027)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_PATH_ACTIVATE UINT16_C(1028)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_PATH_ACTIVATE_ACK UINT16_C(1029)
#define UCN_V6_PROTOCOL_OPCODE_ROUTE_ERROR UINT16_C(1030)
