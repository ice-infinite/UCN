#ifndef UCN_PORTS_ZEPHYR_H
#define UCN_PORTS_ZEPHYR_H
...
} ucn_zephyr_port_ops_t;

typedef struct ucn_zephyr_port_config {
    ucn_protocol_owner_config_t owner;
    const ucn_zephyr_port_ops_t *ops;
    void *runtime_context;
} ucn_zephyr_port_config_t;

typedef struct ucn_zephyr_port {
