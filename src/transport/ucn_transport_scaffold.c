...
static const ucn_i_module_scaffold_descriptor_t transport_scaffold = {
    sizeof(ucn_i_module_scaffold_descriptor_t),
    UCN_I_MODULE_SCAFFOLD_SCHEMA,
    UCN_I_MODULE_TRANSPORT,
    6U,
    UCN_I_DEP_COMMON | UCN_I_DEP_COORDINATOR,
    UCN_I_DEP_SECURITY | UCN_I_DEP_ROUTING | UCN_I_DEP_PERSISTENCE,
    UCN_I_DEP_SECURITY | UCN_I_DEP_ROUTING | UCN_I_DEP_PERSISTENCE,
