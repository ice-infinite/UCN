...
static const uint8_t golden_a0[] = {
    0x55U, 0x43U, 0x06U, 0x01U, 0x08U, 0x00U, 0x00U, 0x01U,
    0x01U, 0x11U, 0x22U, 0x33U, 0x44U, 0x00U, 0xFFU, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x04U, 0x01U, 0x02U, 0xDEU,
    0xADU, 0xBEU, 0xEFU, 0x90U, 0xDBU, 0x5EU, 0x23U
};
static const uint8_t golden_a1[] = {
    0x55U, 0x43U, 0x46U, 0x01U, 0x08U, 0x00U, 0x00U, 0x01U,
    0x01U, 0x11U, 0x22U, 0x33U, 0x44U, 0x00U, 0x00U, 0xFFU,
    0xFFU, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x04U, 0x01U,
    0x02U, 0xDEU, 0xADU, 0xBEU, 0xEFU, 0x06U, 0x2DU, 0xAAU,
    0xB6U
};
static const uint8_t golden_a2[] = {
    0x55U, 0x43U, 0x86U, 0x01U, 0x08U, 0x00U, 0x00U, 0x01U,
    0x01U, 0x11U, 0x22U, 0x33U, 0x44U, 0x00U, 0x00U, 0x00U,
    0xFFU, 0xFFU, 0xFFU, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x04U, 0x01U, 0x02U, 0xDEU, 0xADU, 0xBEU, 0xEFU, 0xE6U,
    0x4EU, 0x61U, 0x4FU
};
static const uint8_t golden_a3[] = {
    0x55U, 0x43U, 0xC6U, 0x01U, 0x08U, 0x00U, 0x00U, 0x01U,
    0x01U, 0x11U, 0x22U, 0x33U, 0x44U, 0x00U, 0x00U, 0x00U,
    0x00U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
    0x00U, 0x00U, 0x04U, 0x01U, 0x02U, 0xDEU, 0xADU, 0xBEU,
    0xEFU, 0x93U, 0xA6U, 0x5AU, 0x53U
};
...
static int test_full_context_round_trip_and_aad(void)
{
    ...
    /* The Wire field must preserve the complete Route/Capability hop domain,
     * including its largest usable value; UINT16_MAX remains the sentinel. */
    frame.hop_limit = UCN_V6_HOP_COUNT_MAX;
    CHECK(ucn_v6_wire_encode(&frame, wire, sizeof(wire), &wire_length) ==
          UCN_V6_OK);
    CHECK(ucn_v6_wire_decode(wire, wire_length, &decoded) == UCN_V6_OK);
    CHECK(decoded.hop_limit == UCN_V6_HOP_COUNT_MAX);
    return 0;
}
...
static int test_semantic_negative_matrix(void)
{
          ...
          decoded.path.path_generation == both.path.path_generation);
    {
        ...
        size_t aad_length = 0U;
        CHECK(ucn_v6_wire_write_canonical_aad(
                  &both, aad, sizeof(aad), &aad_length) == UCN_V6_OK);
        CHECK(aad_length == UCN_V6_CANONICAL_AAD_BYTES);
        CHECK(aad[58] == 3U);
        CHECK(aad[59] == 0x31U && aad[60] == 0x32U &&
              aad[61] == 0x33U && aad[62] == 0x35U);
        CHECK(aad[63] == 0x75U && aad[64] == 0x76U);
        CHECK(aad[65] == 0x77U && aad[66] == 0x78U &&
              aad[67] == 0x79U && aad[68] == 0x7AU);
    }
    bad = base;
    bad.e2e.key_id = 0U;
    CHECK(expect_encode_reject_no_write(&bad) == 0);
