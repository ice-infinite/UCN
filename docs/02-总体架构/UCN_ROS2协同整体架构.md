...
相关基础文档：[UCN 整体架构设计](UCN_整体架构设计.md) · [UCN 协议分层与配置档案](../01-入门与使用/UCN_协议分层与配置档案.md)
...
因此本文件中的 ROS2/Host 图和 Bridge 配置示例是目标架构，不应被理解为仓库已经提供的可运行 ROS2 Bridge。当前 Adapter API 与收包模型见 [UCN Adapter 契约](../06-平台与适配/UCN_Adapter_契约.md)。
