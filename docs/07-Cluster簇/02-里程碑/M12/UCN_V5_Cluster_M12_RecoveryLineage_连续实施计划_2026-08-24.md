...
- 每节点自审：FULL Debug 构建 + ucn_tests 全绿（含既有全部回归）+ 该节点定向测试逐条 PASS；P0 节点另跑 ASan/UBSan；OP 记录（OP-351 起）+ 分项自审报告（`docs/07-Cluster簇/02-里程碑/M12/UCN_V5_Cluster_M12_<节点>_自审报告_2026-08-24.md`）。
