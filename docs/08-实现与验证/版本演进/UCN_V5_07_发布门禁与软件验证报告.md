...
> 结论：本文记录 V5-07 当时的软件发布门禁；V5-08～V5-33 后续变化以本文的“当前值更新”、[文档与代码一致性审计](../../09-审计与整改/UCN_V5_文档与代码一致性审计.md)、[异构 Bearer、动态 MTU 与 Policy 修复报告](UCN_V5_27_异构Bearer与动态MTU修复报告.md)和[PATH_INSTALL 兼容与 API 符号修复报告](UCN_V5_31_PATH_INSTALL兼容与API符号修复报告.md)为准。生产密码与目标板实机始终是独立门禁。
...
> 当前值更新：V5-44/V5-36 后重新测得 Nano/Lite/Full Node 为 `2648/6024/10080 B`，Archive `.text` 为 `27662/73735/139017 B`，Link 仍为 40 B，Storage Layout Version=5。本表保留 V5-07 当时的发布证据。
