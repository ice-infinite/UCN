...
> `SUPERSEDED SELF-REVIEW SNAPSHOT`：本文“没有已知开放的软件 P0/P1”等结论只代表当时的自审工作树，随后已被外审 AUD-01～05 推翻。当前五项外审问题虽已在本地整改并通过新一轮自审，但仍等待外部复审；请以《UCN V6 外审 AUD-01～05 整改与自审报告（2026-09-06）》为当前状态，V6-15/RC 继续 HOLD。
