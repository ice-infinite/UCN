...
> 状态：`EXTERNAL NO-GO REMEDIATED / RE-SELF-REVIEW PASS / WAIT EXTERNAL RE-REVIEW`
>
> 适用分支：`v6-simplified`
>
...
```ini
IMPL02-X02..X06 = EXTERNAL REVIEW GO
IMPL02-X01-B    = REMEDIATED / RE-SELF-REVIEW PASS / WAIT EXTERNAL RE-REVIEW
IMPL-02-00..08 = DONE / RE-SELF-REVIEW PASS
IMPL-02-09     = WAIT EXTERNAL RE-REVIEW
Open P0/P1     = 0 found in Host software scope
IMPL-03        = BLOCKED BY IMPL-02 EXTERNAL REVIEW
```
