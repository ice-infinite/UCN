...
> 关联：[节点内任务通信建议](../../05-传输与服务/UCN_节点内任务通信建议.md) · [T25.0 首版 Endpoint 与 Service 契约](UCN_T25_首版Endpoint与Service契约.md) · [整体架构](../../02-总体架构/UCN_整体架构设计.md) · [v4 协议核心说明](UCN_v4_协议核心说明.md) · [任务表](../../00-项目管理/00-任务表.md)。
