...
> | M12 RecoveryLineage | DONE / SELF-AUDIT PASS / WAIT EXTERNAL | 12-01..12-10 完成（未提交，工作区 wt/m35） | 逐节点自审全部 PASS（OP-351..360 + 9 份分项报告）；里程碑门禁 3/3、禁止事项 3/3；FULL/ASan/LITE/NANO 全绿；OBSERVED 30 零违例；Golden 8b80b08；cluster_bytes 1616。等待外部复审；M05/M08/M10 边界不解除。 |
...
| `CLV2-11-10` | P0 | 11-01..09 | Merge suite | **SELF-AUDIT PASS / WAIT EXTERNAL RE-REVIEW（受限实验范围）**：组合覆盖双簇 capacity、抖动、retry/replay、赢家/撤权后旧 Head故障、Backup/Provisional 和 Stepdown，并新增 RFC typed 对照、duration/serial、target commit deadline/no-fake-durable、transaction corruption、撤权 transaction 的 Begin/Reset→Begin，以及 R07 连续合格与 R08-A replay-namespace/ABA 反例。 | 全量矩阵与边界扫描通过；结果仅限实验软件模型，须重新外审。 |
